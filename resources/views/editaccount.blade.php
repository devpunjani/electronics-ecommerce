                ...
                <div class="card-body p-md-3" >
                  <div class="row justify-content-center" >
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1" style="padding-left: 60px;" >
                      ...
                      <p class="text-center h2 fw mb-5 mx-1 mx-md-4 mt-4">Edit Account</p>

                  <form class="mx-1 mx-md-4" method="post" action="{{ route('updateaccount') }}" enctype="multipart/form-data">
                    @csrf

                        <div class="d-flex flex-row align-items-center mb-4">
                          <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                          <div class="form-outline flex-fill mb-0">
                            <input type="text" id="form3Example1c" name="name" class="form-control" value="{{ $account->name }}" />
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                          ...
                          <div class="form-outline flex-fill mb-0">
                            <input type="number" id="form3Example1c" name="phone" class="form-control" value="{{ $account->phone }}"/>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                            <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                            <div class="form-outline flex-fill mb-0">
                              <input type="text" id="form3Example1c" name="email1" class="form-control" value="{{ $account->email }}" disabled/>
                        ...
                        <div class="d-flex flex-row align-items-center mb-4">
                            ...
                            <div class="form-outline flex-fill mb-0">
                              <textarea placeholder="Address" name="address" id="form3Example1c" class="form-control" value="" style="width:330px;">{{ $account->address}}</textarea>
                            </div>
                        </div>

                        <script>
                            var add = document.getElementByName('address');
                            add.textContent = {{ $account->address }};
                        </script>
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2" style="padding-left: 275px;">
                      <div>
                        <h5 style="padding-left: 40px;padding-bottom:10px;"> Change Profile Photo</h5>
                        <div class="d-flex justify-content-right mb-4">
                            ...
                            @else
                                <img src="{{asset('/userImage/'.$account->photourl)}}" id="photo" class="rounded-circle" alt="Photo" style="width: 230px;height: 200px;object-fit:fill;"/>
                            @endif
                        </div>
